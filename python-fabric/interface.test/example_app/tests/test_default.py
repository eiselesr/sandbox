...
sys.path.append('/home/riaps/projects/eiselesr/sandbox/python-fabric/interface.test/example_app')
...
def test_app():
    ...
    c = test_api.launch_riaps_app(
        app_folder_path="/home/riaps/projects/eiselesr/sandbox/python-fabric/interface.test/example_app",
        app_file_name="Demo.riaps",
